...
public partial class SettingsViewModel : BaseViewModel
{
    ...
    private async Task SaveServerAsync()
    {
        ...
        {
            await Shell.Current.DisplayAlertAsync("Validation Error", "All fields are required.", "OK");
            return;
        }
        ...
        {
            await Shell.Current.DisplayAlertAsync("Validation Error", "Please enter a valid URL (e.g., https://komga.example.com)", "OK");
            return;
        }
